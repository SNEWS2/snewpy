...
vector<vector<MATRIX<complex<double>,NF,NF> > > UpdateSm(double rminus,double rplus,vector<vector<array<double,NY> > > &Y,vector<vector<array<MATRIX<complex<double>,NF,NF>,NF> > > &C0,vector<vector<array<array<double,NF>,NF> > > A0,vector<vector<MATRIX<complex<double>,NF,NF> > > &Smprior)
...
vector<vector<array<MATRIX<complex<double>,NF,NF>,NF> > > UpdateC(double r)
          { array<MATRIX<complex<double>,NF,NF>,NM> VfMSW;
            MATRIX<complex<double>,NF,NF> Hf,Hfbar;
