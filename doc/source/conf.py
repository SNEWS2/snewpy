# -*- coding: utf-8 -*-
#
# snewpy documentation build configuration file, created by
...
project = u'snewpy'
copyright = u'2021, SNEWS 2.0 Collaboration'
...
latex_documents = [
  ('index', 'snewpy.tex', u'snewpy Documentation',
   u'SNEWS 2.0 Collaboration', 'manual'),
]
...
man_pages = [
    ('index', 'snewpy', u'snewpy Documentation',
     [u'SNEWS 2.0 Collaboration'], 1)
]
...
texinfo_documents = [
  ('index', 'snewpy', u'snewpy Documentation',
   u'SNEWS 2.0 Collaboration', 'snewpy', 'One line description of project.',
   'Miscellaneous'),
]
