...
project = 'snewpy'
copyright = '2022, SNEWS Collaboration'
...
latex_documents = [
  ('index', 'snewpy.tex', 'snewpy Documentation',
   'SNEWS Collaboration', 'manual'),
]
...
man_pages = [
    ('index', 'snewpy', 'snewpy Documentation',
     ['SNEWS Collaboration'], 1)
]
...
texinfo_documents = [
  ('index', 'snewpy', 'snewpy Documentation',
   'SNEWS Collaboration', 'snewpy', 'A Python package for working with supernova neutrinos.',
   'Miscellaneous'),
]
